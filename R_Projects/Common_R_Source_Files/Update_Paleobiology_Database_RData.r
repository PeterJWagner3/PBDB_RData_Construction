...
for (dt in 1:nrow(diacritic_translation))	{
	...
	all_finds_oldid$ref_author <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_finds_oldid$ref_author);
	all_finds_oldid$occurrence_comments <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_finds_oldid$occurrence_comments);
	all_finds_oldid$authorizer <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_finds_oldid$authorizer);
	all_finds_oldid$enterer <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_finds_oldid$enterer);
	all_finds$modifier <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_finds$modifier);
	}
...
for (dt in 1:nrow(diacritic_translation))	{
	...
	all_sites$geological_group <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_sites$geological_group);
...
#all_taxonomy[all_taxonomy$taxon_no==63087,]
...
for (dt in 1:nrow(diacritic_translation))	{
	...
	all_taxonomy$authorizer <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_taxonomy$authorizer);
	all_taxonomy$enterer <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_taxonomy$enterer);
	all_taxonomy$modifier <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_taxonomy$modifier);
	}
...
for (dt in 1:nrow(diacritic_translation))	{
	...
	all_opinions$authorizer <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_opinions$authorizer);
	all_opinions$enterer <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_opinions$enterer);
	all_opinions$modifier <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_opinions$modifier);
	}
...
for (dt in 1:nrow(diacritic_translation))	{
	all_measurements$ref_author <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_measurements$ref_author);
	all_measurements$authorizer <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_measurements$authorizer);
	all_measurements$modifier <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_measurements$modifier);
	all_measurements$enterer <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_measurements$enterer);
	}
...
for (dt in 1:nrow(diacritic_translation))	{
	all_references$reftitle <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$reftitle);
	all_references$author1init <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$author1init);
	all_references$author1last <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$author1last);
	all_references$author2init <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$author2init);
	all_references$author2last <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$author2last);
	all_references$otherauthors <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$otherauthors);
	all_references$attribution <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$attribution);
	all_references$editors <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$editors);
	all_references$refabbr <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$refabbr);
	all_references$pubtitle <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$pubtitle);
	all_references$pubabbr <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$pubabbr);
	all_references$r_journal <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$r_journal);
	all_references$r_booktitle <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$r_booktitle);
	all_references$r_school <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$r_school);
	all_references$publisher <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$publisher);
	all_references$pubcity <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$pubcity);
	all_references$formatted <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$formatted);
	all_references$authorizer <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$authorizer);
	all_references$enterer <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$enterer);
	all_references$modifier <- gsub(diacritic_translation$effed[dt],diacritic_translation$anglo[dt],all_references$modifier);
	}
...
if (!"pbdb_finds_oldid" %in% names(pbdb_data_list))	{
	...
	names(pbdb_data_list) <- c("pbdb_finds","pbdb_sites","pbdb_taxonomy","pbdb_opinions","pbdb_sites_refined","pbdb_finds_oldid",
